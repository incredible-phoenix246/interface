...
export enum CustomMarket {
  ...
  proto_asset_chain_v3 = 'proto_asset_chain_v3',
...
export const marketsData: {
  ...
  [CustomMarket.proto_asset_chain_v3]: {
    marketTitle: 'AssetChain',
    market: CustomMarket.proto_asset_chain_v3,
    chainId: AaveV3AssetChain.CHAIN_ID,
    v3: true,
    enabledFeatures: {
      // governance: true,
      // staking: true,
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: AaveV3AssetChain.POOL_ADDRESSES_PROVIDER,
      LENDING_POOL: AaveV3AssetChain.POOL,
      WETH_GATEWAY: AaveV3AssetChain.WETH_GATEWAY,
      UI_INCENTIVE_DATA_PROVIDER: AaveV3AssetChain.UI_INCENTIVE_DATA_PROVIDER,
      WALLET_BALANCE_PROVIDER: AaveV3AssetChain.WALLET_BALANCE_PROVIDER,
      UI_POOL_DATA_PROVIDER: AaveV3AssetChain.UI_POOL_DATA_PROVIDER,
    },
  },
