...
const ammDisableProposal = 'https://governance-v2.eden.finance/governance/proposal/44';
const ustDisableProposal = 'https://governance-v2.eden.finance/governance/proposal/75';
const kncDisableProposal = 'https://governance-v2.eden.finance/governance/proposal/69';
const v2MainnetDisableProposal = 'https://governance-v2.eden.finance/governance/proposal/111';
const v2MainnetDisableProposal2 = 'https://governance-v2.eden.finance/governance/proposal/125';
const v2PolygonDisableProposal = 'https://governance-v2.eden.finance/governance/proposal/124';
